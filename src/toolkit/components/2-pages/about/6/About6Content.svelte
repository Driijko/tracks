<section>
  ...
  <ul>
    <li>
      ...
      <img class="project-pic" src="./images/pic18.png" alt="Portfolio website." />
      <div class="bottom">
    ...
    <li>
      ...
      <img class="project-pic" src="./images/pic19.jpg" alt="Album cover of The Unassumed by As Above/So Below. " />
      <div class="bottom">
        <p class="project-description">
    ...
    <li>
      <h4>nonono</h4>
      <img class="project-pic" src="./images/pic20.jpg" alt="Album cover of 'mood' by the group 'nonono'." />
      <div class="bottom">
        <p class="project-description">
