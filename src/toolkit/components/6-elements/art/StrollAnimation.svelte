...
<script>
  ...
  // PATHS ---------------------------
  const fill = "hsla(40, 100%, 50%, 0)";

  // ANIMATION
  const duration = 52;
  const duration1 = 44;
  const duration2 = 30;
  const duration3 = 12.5;
  const duration4 = 60;
  const ease = "power1.out";


  // START
  const strokeDashArrayStart = "5 10";

  // END 
  const strokeDashArrayStage1 = "1 15";
  const strokeDashArrayStage2 = "1 8";
  const strokeDashArrayStage3 = "1 8";
  ...
  onMount(()=> {
    ...
    tl.to("#svg1 .path1", {
      duration: duration1,
      ease: ease,
      strokeDasharray: strokeDashArrayStage1,
      attr: {
    ...
    tl.to("#svg1 .path1", {
      duration: duration2,
      ease: ease,
      strokeDasharray: strokeDashArrayStage2,
...
<svg id="svg1" viewBox="0 0 1600 900">
  ...
  <path class="path1" stroke="hsl(150, 100%, 50%)" stroke-width="10"
    fill={fill}
    stroke-dasharray={strokeDashArrayStart} stroke-linejoin="round" stroke-linecap="round"
