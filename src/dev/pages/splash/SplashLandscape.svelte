...
<script>
  ...
  onMount(()=> {
    // ANIMATION --------------------------------------------------
    tl.from(["#p2-r1", "#p2-r2", "#p2-r3", "#p2-r4"], {duration: 2, opacity: 0},0);
    tl.to("#p2-r1", {duration: 5, fill: "hsl(340, 100%, 70%)", ease: "linear",repeat: -1, yoyo: true, repeatDelay: 1},2);
    tl.to(["#p2-r2", "#p2-r3", "#p2-r4"], {duration: 5, fill: "hsl(350, 100%, 10%)", ease: "linear",repeat: -1, yoyo: true, repeatDelay: 1},2);
...
<main id="p2l">
  <svg class="svg-background" viewBox="0 0 1600 900" >
    ...
    <rect id="p2-r1" fill="hsl(350, 100%, 10%)" x="0" y="0" width="300" height="900" />
    <rect id="p2-r2" fill="hsl(340, 100%, 70%)" x="300" y="0" width="1300" height="50" />
    <rect id="p2-r3" fill="hsl(340, 100%, 70%)" x="300" y="850" width="1300" height="50" />
    <rect id="p2-r4" fill="hsl(340, 100%, 70%)" x="1100" y="50" width="400" height="800" />
